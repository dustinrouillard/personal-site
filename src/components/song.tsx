...
export function Song({ song }: { song: RecentSong }) {
  ...
  return (
    <a
      ...
      target="_blank"
    >
      <div className="flex flex-row items-start lg:items-center rounded-lg m-1 bg-neutral-200 dark:bg-black/60 py-6 px-4 min-w-[20rem] border-b-8 border-b-[#1ED760]/50 hover:border-b-[#1ED760] cursor-pointer hover:brightness-75 transition-all">
        <div className="flex flex-col xl:flex-row items-start w-full justify-between overflow-hidden">
          ...
          <div className="flex-col invisible hidden xl:flex xl:visible">
